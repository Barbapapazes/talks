/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 21456f04b5e0b33d48c45eb6df4265a3)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TALKS_TRIGGER_REDEPLOY_LINKED_WEBSITES: Workflow<Parameters<import("./index").TriggerRedeployLinkedWebsitesWorkflow['run']>[0]['payload']>;
	}
}
