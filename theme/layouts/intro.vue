...
<template>
  <div class="slidev-layout intro">
    ...
    <!-- <template v-if="$frontmatter.stickers">
      ...
      <VAfter>
        <img src="../assets/takima/dark-vador.png" class="absolute h-1/2 top-8 rotate-350 drop-shadow-md duration-300 ease-out forward:delay-50">
      </VAfter>
      <VAfter>
        <img src="../assets/takima/git-poule.png" class="absolute h-1/2 top-16 left-1/2 -translate-x-1/2 drop-shadow-md duration-300 ease-out forward:delay-75">
      </VAfter>
      <VAfter>
        <img src="../assets/takima/pear-programming.png" class="absolute h-1/2 right-8 top-8 drop-shadow-md duration-300 ease-out forward:delay-125">
      </VAfter>
      <VAfter>
        <img src="../assets/takima/of-course-my-code-works.png" class="absolute h-1/3 bottom-4 left-1/3 -translate-x-1/2 rotate-359 drop-shadow-md duration-300 ease-out forward:delay-75">
      </VAfter>
      <VAfter>
        <img src="../assets/takima/taking-control.png" class="absolute h-1/3 bottom-4 left-2/3 -translate-x-1/2 rotate-2 drop-shadow-md duration-300 ease-out forward:delay-100">
      </VAfter>
    </template> -->
  </div>
</template>
