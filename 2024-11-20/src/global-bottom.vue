...
<template>
  ...
  >
    <div
      class="clip bg-gradient-to-r to-white/10 from-[#3730a3]"
      :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-l to-white/10 from-[#6b21a8]"
      :style="{ 'clip-path': `polygon(${poly2})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-t to-white/10 from-[#9d174d]"
